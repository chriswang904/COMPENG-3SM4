public class MinBinHeap {
    ...
    public MinBinHeap(Graph g, int r) {
        ...
        for (int i = 0; i < this.size; i++) {
            g.v[i].key = i == r ? 0 : Graph.infinity; // Set key to 0 for the starting vertex, infinity for others
            g.v[i].heapIndex = i; // The initial heapIndex is the same as the vertex's index in the graph
